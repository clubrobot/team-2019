...
VELOCITYCONTROL_MAXLINACC_VALUE     = 750
...
LINVELPID_KP_VALUE                  = 1.79999999
LINVELPID_KI_VALUE                  = 035
LINVELPID_KD_VALUE                  = 0

LINVELPID_MINOUTPUT_VALUE           = -1100
LINVELPID_MAXOUTPUT_VALUE           = 1100 

ANGVELPID_KP_VALUE                  = 1.6
ANGVELPID_KI_VALUE                  = 40
ANGVELPID_KD_VALUE                  = 0

ANGVELPID_MINOUTPUT_VALUE	        = -9#-18.0278263092041
ANGVELPID_MAXOUTPUT_VALUE	        = 9#18.0278263092041

POSITIONCONTROL_LINVELKP_VALUE      = 3
POSITIONCONTROL_ANGVELKP_VALUE      = 2.2

POSITIONCONTROL_LINVELMAX_VALUE     = 500

...
class VL6180X
{
  public:
    ...
    uint8_t readRangeSingle(void (*functionPointer)());
    inline uint16_t readRangeSingleMillimeters(void (*functionPointer)()) { return (uint16_t)scaling * readRangeSingle(functionPointer); }
    ...
    uint8_t readRangeContinuous(void (*functionPointer)());
    inline uint16_t readRangeContinuousMillimeters(void (*functionPointer)()) { return (uint16_t)scaling * readRangeContinuous(functionPointer); }
